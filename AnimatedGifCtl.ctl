...
Attribute VB_Ext_KEY = "PropPageWizardRun" ,"Yes"
 ...
 Dim clsDialog As Object 'New clsCommonDialog
...
Attribute StopRender.VB_ProcData.VB_Invoke_Property = "PropPage1"
 ...
 clsDialog.ShowColor
 lngTemp = clsDialog.Color
 If lngTemp <> UserControl.BackColor Then
     UserControl.BackColor = lngTemp
     ClearControl
 End If
 ' For Access Version
  ...
  End Function
   ...
   ' temp var for DC's current BackColor
    ...
    ' Display the File Dialog
     ...
     strGifFileName = clsDialog.FileName
     Else
     ' Add error handling
     End If
     End Function
